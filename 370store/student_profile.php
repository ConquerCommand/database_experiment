...
if ($viewer_id !== $student_id) {
    ...
    if (!$rel_ok) {
        // not assigned
        header("Location: apprentices_status.php");
        exit();
    }
}
...
<head>
    ...
    <link rel="stylesheet" href="/370store/css/roadmap.css">
    <style>
...
<body>
    ...
    <div class="menu-items">
        ...
        <a href="apprentices_status.php" class="menu-item active">
            <i class="fas fa-users"></i>
            <span>Apprentices Status</span>
        </a>
    </div>
            ...
            <div style="padding:20px 25px;">
                <div class="profile-header">
                    ...
                    <div style="margin-left:auto; text-align:right;">
                        <a href="apprentices_status.php" class="small-action"><i class="fas fa-arrow-left"></i> Back to Apprentices</a>
